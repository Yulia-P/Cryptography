...
namespace Lab04
{
    class Cesar
    {
        ...
        {
            Excel.Application XL1 = new Excel.Application();  ///объяв объект
            ...
            XL1.ActiveChart.ChartType = Excel.XlChartType.xlColumnClustered;///столбчатая

            //подписи по оси X
            XL1.ActiveChart.Axes(Excel.XlAxisType.xlCategory).HasTitle = true;
            XL1.ActiveChart.Axes(Excel.XlAxisType.xlCategory).AxisTitle.Characters.Text = "Частота появления";

            //подписи по оси Y
            XL1.ActiveChart.Axes(Excel.XlAxisType.xlCategory).HasTitle = true;
            XL1.ActiveChart.Axes(Excel.XlAxisType.xlCategory).AxisTitle.Characters.Text = "Исходные символы Цезаря";
            ...
            //подписи по оси Y
            XL1.ActiveChart.Axes(Excel.XlAxisType.xlCategory).HasTitle = true;
            XL1.ActiveChart.Axes(Excel.XlAxisType.xlCategory).AxisTitle.Characters.Text = "Шифросимволы Цезаря";
